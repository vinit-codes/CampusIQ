...
const Header: React.FC<HeaderProps> = ({ StudentName = "- Yui Hoshizora" }) => {
  return (
    <nav className="bg-[#EAE4D5] fixed top-0 left-0 h-18 w-full shadow-md z-50 px-4 py-3 flex items-center justify-between">
      {/* Logo */}
      <div className="flex items-center justify-evenly">
        <img
          ...
          onClick={() => window.location.href = "/Dashboard"} // Redirect to Dashboard on click
        />
